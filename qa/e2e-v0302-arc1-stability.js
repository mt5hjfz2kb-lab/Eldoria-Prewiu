...
(async()=>{
 ...
 await p.evaluate(()=>{const el=document.querySelector('[data-node="ashStalker"]');if(typeof centerGuidedWorldNode0267!=='function'||!el)throw new Error('guided world centering helper unavailable');centerGuidedWorldNode0267(el)});
