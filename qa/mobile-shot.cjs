...
(async()=>{
 ...
 await shot('mobile-review-world',{introSeen:true,view:'world',bastionLevel:9,bastion:9,sawmill:true,barracks:true,granary:true,graniteQuarry:true,forge:true,lyra:true,maelis:true,marchConfigured:true,marchSlots:['aldric','lyra'],trial9Done:false},'#app>.e22 [data-testid="world"]');
 await b.close();
