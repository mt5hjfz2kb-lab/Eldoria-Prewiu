...
namespace Eldoria.EditorTools
{
    ...
    public static class ValoriaBenchmarkCapture
    {
        public static void Capture()
        {
            ...
            Save(camera,folder+"/valoria-establishing.png",new Vector3(20.5f,22.5f,-24f),new Vector3(0,2.25f,2.8f),12.4f,1280,720);
            Save(camera,folder+"/valoria-gate.png",new Vector3(8.8f,15f,-19f),new Vector3(0,2.3f,3.0f),9.2f,1280,720);
            Save(camera,folder+"/valoria-districts.png",new Vector3(-17f,18f,-12f),new Vector3(0,1.8f,1.5f),10.2f,1280,720);
