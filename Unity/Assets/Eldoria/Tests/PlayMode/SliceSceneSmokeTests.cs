...
namespace Eldoria.Tests
{
    public sealed class SliceSceneSmokeTests
    {
        ...
        public IEnumerator ValoriaBenchmarkArtKeepsGameplayHotspots()
        {
            ...
            Assert.That(GameObject.Find("Bastion · connected tower west"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · connected tower east"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · rear connected tower west"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · rear connected tower east"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · keep detailed facing"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · dead palace wall west"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · dead palace wall east"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · dead palace tower remnant"),Is.Not.Null);
            Assert.That(GameObject.Find("Bastion · dead palace arch · left pier"),Is.Null,
                "The oversized procedural palace arch failed capture review and must stay out");
            ...
            Assert.That(GameObject.Find("Valoria · rear pine · trunk"),Is.Not.Null,
